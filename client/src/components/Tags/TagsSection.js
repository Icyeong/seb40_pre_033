      ...
      <TagInfo>
        <div>
          ...
          <h5>
            ...
            [python-3.x] tag. When using a Python variant (e.g. Jython, PyPy) or
            library (e.g. Pandas, NumPy), please include it in the tags.
          </h5>
          <TagQuestion>
      ...
      <TagInfo>
        <div>
          ...
          <h5>
            ...
            itself. This tag is frequently used alongside other tags for
            libraries and/or frameworks used by Java developers.
          </h5>
          <TagQuestion>
      ...
      <TagInfo>
        <div>
          ...
          <h5>
            ...
            which include .NET, .NET Framework, .NET MAUI, and Xamarin among
            others. Use this tag for questions about code written in C# or about
            C#`s formal specification.
          </h5>
          <TagQuestion>
